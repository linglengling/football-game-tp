	...
	foreach ( $players as $index => $p ) :
		...
		<div class="anwp-grid-table__td players-shortcode__player d-flex align-items-center justify-content-start">
			...
			<?php if ( AnWP_Football_Leagues::string_to_bool( $data->show_photo ) ) : ?>
				<img loading="lazy" width="35" height="35" class="players-shortcode__photo anwp-object-contain my-2 mr-2 anwp-w-35 anwp-h-35" src="<?php echo esc_url( $player->photo ?: $default_photo ); ?>"
					alt="<?php echo esc_attr( $player->name_short ); ?>">
			<?php endif; ?>

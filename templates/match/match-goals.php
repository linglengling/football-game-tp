...
<div class="match-goals anwp-section">
	...
	*/
	...
	<?php foreach ( $data->events['goals'] as $e_index => $e ) : ?>
					...
					<div class="match__event-content anwp-leading-1-25 anwp-text-base">
						...
						<div class="match__event-player">
							...
							if ( ! empty( $temp_players ) && 'temp__' === mb_substr( $e->assistant, 0, 6 ) ) :
								...
								<?php
							elseif ( ! empty( $e->assistant ) ) :
								$assistant = anwp_football_leagues()->player->get_player( $e->assistant );
								?>
								<span class="mx-1 anwp-text-nowrap">
									(<span class="anwp-text-sm anwp-opacity-80 match__goals-assistant"><?php echo esc_html( AnWPFL_Text::get_value( 'match__goals__assistant', __( 'Assistant', 'anwp-football-leagues' ) ) ); ?></span>:
									<a class="anwp-link-without-effects match__event-player-name" href="<?php echo esc_url( $assistant->link ); ?>"><?php echo esc_html( $assistant->name_short ); ?></a>)
								</span>
							<?php endif; ?>
						</div>
					</div>
					...
					<div class="match__event-content anwp-leading-1-25 anwp-text-base ml-auto ml-sm-0">
						...
						<div class="match__event-player">
							...
							elseif ( ! empty( $e->assistant ) ) :
								...
								<span class="mx-1 anwp-text-nowrap">
									(<span class="anwp-text-sm anwp-opacity-80 match__goals-assistant"><?php echo esc_html( AnWPFL_Text::get_value( 'match__goals__assistant', __( 'Assistant', 'anwp-football-leagues' ) ) ); ?>:</span>
									<a class="anwp-link anwp-link-without-effects match__event-player-name" href="<?php echo esc_url( $assistant->link ); ?>"><?php echo esc_html( $assistant->name_short ); ?></a>)
								</span>
							<?php endif; ?>
						</div>
					</div>

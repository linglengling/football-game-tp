...
$position       = 'anwp_staff' === $data->post_type ? $data->position : anwp_football_leagues()->player->get_translated_position( $data->ID, $data->position );
...
<div class="player__birthday-card player-birthday-card anwp-fl-border anwp-border-light d-flex align-items-start position-relative">
	...
	<div class="d-flex flex-column flex-grow-1 player-birthday-card__meta py-2 pl-1">
		...
		<?php if ( $position ) : ?>
			<div class="player-birthday-card__position anwp-text-sm anwp-leading-1-5"><?php echo esc_html( $position ); ?></div>
		<?php endif; ?>
		<?php
